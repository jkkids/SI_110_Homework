...
def name_counts(names):
    ...
    listoftuples = []
    for words in names:
        if words not in dictoftuples:
        	dictoftuples[words] = names.count(words)
        	listoftuples.append((words,dictoftuples[words]))
